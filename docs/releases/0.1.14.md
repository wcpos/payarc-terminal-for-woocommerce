...
- **Declines now say why.** The final poll/callback payload's processor
  response, PayArc error, and card entry mode are shown to the cashier,
  written to the order note, and logged with the resolved attempt — instead
  of the bare word "decline".
